...
public final class AdminDtos {
 private AdminDtos(){}
 public record CategoryInput(@NotBlank @Size(max=160) String name,@NotBlank @Size(max=160) @Pattern(regexp="^[a-z0-9]+(-[a-z0-9]+)*$") String slug,@Size(max=10000) String description,@NotNull Boolean active,@NotNull @Min(0) Integer displayOrder){}
 public record CategoryView(String id,String name,String slug,String description,boolean active,int displayOrder){}
